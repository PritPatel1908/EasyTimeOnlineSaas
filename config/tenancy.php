...
use App\TenantDatabaseManagers\SQLServerDatabaseManager;
...
return [
    ...
    'central_domains' => array_values(array_filter([
        env('CENTRAL_DOMAIN_LOCAL'),
        env('CENTRAL_DOMAIN_PROD'),
    ])),

    'base_domains' => [
        'local' => env('TENANT_BASE_DOMAIN_LOCAL', 'saas.test'),
        'prod' => env('TENANT_BASE_DOMAIN_PROD', 'myapp.com'),
    ],
    ...
    'database' => [
         ...
         */
        'prefix' => env('TENANT_DATABASE_PREFIX', 'tenants/tenant-'),
        'suffix' => '',
