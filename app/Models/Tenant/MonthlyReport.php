...
class MonthlyReport extends Model
{
    ...
    protected $casts = [
        ...
        'report_type' => MonthlyReportTypes::class,
    ...
    {
        return $this->belongsToMany(Category::class, 'monthly_report_category')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Company::class, 'monthly_report_company')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Department::class, 'monthly_report_department')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(SubCategory::class, 'monthly_report_sub_category')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(SubDepartment::class, 'monthly_report_sub_department')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Area::class, 'monthly_report_area')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(User::class, 'monthly_report_user')
            ->withPivot('id')
            ->withTimestamps();
    }
}
