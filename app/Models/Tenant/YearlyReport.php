...
class YearlyReport extends Model
{
    ...
    protected $casts = [
        ...
        'report_type' => YearlyReportTypes::class,
    ...
    {
        return $this->belongsToMany(Category::class, 'yearly_report_category')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Company::class, 'yearly_report_company')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Department::class, 'yearly_report_department')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(SubCategory::class, 'yearly_report_sub_category')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(SubDepartment::class, 'yearly_report_sub_department')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(Area::class, 'yearly_report_area')
            ->withPivot('id')
            ->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany(User::class, 'yearly_report_user')
            ->withPivot('id')
            ->withTimestamps();
    }
}
