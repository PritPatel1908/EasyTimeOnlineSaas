...
use App\Enums\ReportColumns\EarlyGoingReportColumns;
...
class EarlyGoingReportGenerator
{
    protected MonthlyReport $monthlyReport;

    protected $totalEarly;
    ...
    private $orderMap = [
        EarlyGoingReportColumns::date->value => 1,
        EarlyGoingReportColumns::code->value => 2,
        EarlyGoingReportColumns::name->value => 3,
        EarlyGoingReportColumns::location_name->value => 4,
        EarlyGoingReportColumns::location_code->value => 5,
        EarlyGoingReportColumns::company_name->value => 6,
        EarlyGoingReportColumns::company_code->value => 7,
        EarlyGoingReportColumns::department_name->value => 8,
        EarlyGoingReportColumns::department_code->value => 9,
        EarlyGoingReportColumns::sub_department_name->value => 10,
        EarlyGoingReportColumns::sub_department_code->value => 11,
        EarlyGoingReportColumns::category_name->value => 12,
        EarlyGoingReportColumns::category_code->value => 13,
        EarlyGoingReportColumns::sub_category_name->value => 14,
        EarlyGoingReportColumns::sub_category_code->value => 15,
        EarlyGoingReportColumns::shift->value => 16,
        EarlyGoingReportColumns::shift_out_time->value => 17,
        EarlyGoingReportColumns::night_shift->value => 18,
        EarlyGoingReportColumns::out_time->value => 19,
        EarlyGoingReportColumns::early->value => 20,
        EarlyGoingReportColumns::status->value => 21,
    ];
    ...
    public function generateEarlyGoingReport(): void
    {
        ...
        // Get is_late records
        $attendanceDetails->where('is_early', true);
    ...
    public function generateDetailedCsvReport($result)
    {
        ...
        //     $heading[] = EarlyGoingReportColumns::{$column}->getLabel();
        // }
    ...
    public function generateDetailedXlsxReport($result)
    {
        ...
        $reportTitle = 'Early Going Report';
    ...
    public function renderCSVTree($result)
    {
        ...
        foreach ($result as $employeeId => $records) {
            ...
            // $totalRow[count($this->selected_columns) - 1] = sprintf('%02d:%02d', floor($this->totalEarly / 60), $this->totalEarly % 60);
            // $csv[] = $totalRow;
    ...
    public function renderDetailedCSVColumns($attendance)
    {
        ...
        foreach ($this->selected_columns as $column) {
            switch ($column) {
                ...
                case 'early':
                    $final_early = '';
                    if ($attendance->shift != null && $attendance->out_time != null && $attendance->shift_out_time != null) {
