        ...
        foreach ($this->selected_columns as $column) {
            switch ($column) {
                ...
                case 'category_code':
                    ...
                    break;
                case 'leave_type':
                    if ($transaction->referenceable_type == 'App\Models\Tenant\GradeWiseYearlyLeaveDetail' || $transaction->referenceable_type == 'App\Models\Tenant\GradeWiseYearlyLeaveDetail') {
