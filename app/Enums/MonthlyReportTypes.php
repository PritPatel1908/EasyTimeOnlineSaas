...
enum MonthlyReportTypes: string implements HasLabel
{
    ...
    case manualpunchReport = 'manualpunch_report';
    case summaryReport = 'summary_report';
    case leaveBalanceReport = 'leave_balance_report';
    case leaveInfoReport = 'leave_info_report';
    ...
    public function getLabel(): ?string
    {
        return match ($this) {
            ...
            self::manualpunchReport => 'Manual Punch Report',
            self::summaryReport => 'Summary Report',
            self::leaveBalanceReport => 'Leave Balance Report',
            self::leaveInfoReport => 'Leave Info Report',
        };
    }
}
