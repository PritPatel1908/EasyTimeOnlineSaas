...
enum InOutReportColumns: string implements HasLabel
{
    case date = 'date';
    case code = 'code';
    case name = 'name';
    ...
    case in_out_time = 'in_out_time';
    // case in_time = 'in_time';
    // case out_time = 'out_time';
    case actual_working_hrs = 'actual_working_hrs';
    case break_hrs = 'break_hrs';
    case total_hrs = 'total_hrs';
    ...
    public function getLabel(): ?string
    {
        return match ($this) {
            ...
            self::in_out_time => 'In/Out Time',
            // self::in_time => 'In Time',
            // self::out_time => 'Out Time',
            self::actual_working_hrs => 'Actual Working Hrs',
            self::break_hrs => 'Break Hrs',
            self::total_hrs => 'Total Hrs',
