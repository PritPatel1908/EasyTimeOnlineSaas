...
enum IrregularReportColumns: string implements HasLabel
{
    case date = 'date';
    case code = 'code';
    case name = 'name';
    ...
    case late = 'late';
    case early = 'early';
    case in_month_late = 'in_month_late';
    case in_month_early = 'in_month_early';
    case status = 'status';
    ...
    public function getLabel(): ?string
    {
        return match ($this) {
            ...
            self::late => 'Late',
            self::early => 'Early',
            self::in_month_late => 'In Month Late',
            self::in_month_early => 'In Month Early',
            self::status => 'Status'
        };
    }
}
