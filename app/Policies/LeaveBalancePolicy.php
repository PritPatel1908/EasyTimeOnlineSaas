...
class LeaveBalancePolicy
{
     ...
     */
    public function view(User $user, ManualLeaveBalance $leaveBalance): bool
    {
     ...
     */
    public function update(User $user, ManualLeaveBalance $leaveBalance): bool
    {
     ...
     */
    public function delete(User $user, ManualLeaveBalance $leaveBalance): bool
    {
     ...
     */
    public function forceDelete(User $user, ManualLeaveBalance $leaveBalance): bool
    {
     ...
     */
    public function restore(User $user, ManualLeaveBalance $leaveBalance): bool
    {
     ...
     */
    public function replicate(User $user, ManualLeaveBalance $leaveBalance): bool
    {
