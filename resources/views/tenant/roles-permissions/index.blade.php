            ...
            <div class="card-body p-0">
                ...
                @forelse ($roles as $role)
                    <tr>
                        ...
                        <td><span class="badge badge-light">{{ $role->permissions->count() }} assigned</span></td>
