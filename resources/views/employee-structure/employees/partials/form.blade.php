                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3"><label class="form-label">Mobile Login</label><div class="form-check mt-2"><input type="hidden" name="allow_mobile_login" value="0"><input type="checkbox" name="allow_mobile_login" value="1" class="form-check-input" @checked($value('allow_mobile_login'))><label class="form-check-label">Allow mobile login</label></div></div>
                            <div class="col-md-4 mb-3"><label class="form-label">Mobile Punch</label><div class="form-check mt-2"><input type="hidden" name="allow_mobile_punch" value="0"><input type="checkbox" name="allow_mobile_punch" value="1" class="form-check-input" @checked($value('allow_mobile_punch'))><label class="form-check-label">Allow mobile punch</label></div></div>
                        </div>
                    </div>
                </div>
