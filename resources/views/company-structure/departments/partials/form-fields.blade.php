...
<div class="row">
    ...
    <div class="col-md-6 mb-3"><label class="form-label" for="department_email">Email</label><input id="department_email" type="email" name="email" class="form-control" value="{{ old('email', $department?->email) }}"></div>
