...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6 mb-3"><label class="form-label" for="team_name">Team Name <span class="text-danger">*</span></label><input id="team_name" name="name" class="form-control" value="{{ old('name', $team?->name) }}" required></div>
            <div class="col-md-6 mb-3"><label class="form-label" for="team_code">Team Code <span class="text-danger">*</span></label><input id="team_code" name="code" class="form-control" value="{{ old('code', $team?->code) }}" required></div>
        </div>
    </div>
</div>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12 mb-3"><label class="form-label" for="team_email">Email</label><input id="team_email" type="email" name="email" class="form-control" value="{{ old('email', $team?->email) }}"></div>
        </div>
    </div>
</div>
...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12 mb-3"><label class="form-label" for="team_status">Status <span class="text-danger">*</span></label><select id="team_status" name="status" class="form-control" required><option value="1" @selected(old('status', $team?->status ?? 1) == 1)>Active</option><option value="0" @selected(old('status', $team?->status ?? 1) == 0)>Inactive</option></select></div>
        </div>
    </div>
</div>
